defmodule HelloPhx18Web.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HelloPhx18Web.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HelloPhx18Web.Gettext, "errors", msg, opts)
    end
  end
